        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold" style="color: #22228a;">Surat Keterangan Mahasiswa Aktif</h6>
                    <!-- <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                            ...
                            <a class="dropdown-item" href="javascript:void(0)" onclick="form_pengajuan()">Ajukan Surat</a>
                        </div>
                    </div> -->
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <form action="" method="post" id="form-pengajuan_surat">
                        <div class="form-group" style="display: none;">
                            <input type="text" name="jenis_surat_id" value="1">
...
<!-- <div class="modal fade" id="modal-pengajuan_surat">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Pengajuan Surat</h4>
      ...
      <div class="modal-body">
        <form action="" method="post" id="form-pengajuan_surat">
            <input type="text" name="program_studi_id" value="<?= $user['program_studi_id'] ?>" style="display: none;">
            <input type="text" name="tahun_masuk" value="<?= $user['tahun_masuk'] ?>" style="display: none;">
            <div class="form-group">
                <label for="">NIM</label>
                <input type="text" class="form-control" value="<?= $user['nim'] ?>" disabled="">
            </div>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="button" class="btn btn-primary btn-sm" onclick="ajukan_surat();" style="font-weight: bold;"><i class="fas fa-angle-double-right"></i> Ajukan</button>
      </div>
    </div>
  </div>
</div> -->
...
<script type="text/javascript">
    ...
    //         $('[name="smt_mhs"]').val('').change();
    //         $('#modal-pengajuan_surat').modal('show');
    //     } else {
    //         $('#response').html('');
    //         $(window).scrollTop(0);
